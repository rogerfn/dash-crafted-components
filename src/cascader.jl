...
- `value` (String; optional): The value displayed capture by the component.
...
"""
function cascader(; kwargs...)
        available_props = Symbol[:id, :data, :value, :height, :menuHeight, :menuWidth, :preventOverflow]
        wild_props = Symbol[]
        return Component("cascader", "Cascader", "dash_crafted_components", available_props, wild_props; kwargs...)
end
